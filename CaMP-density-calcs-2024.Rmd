...
### single ecozone
ggplot(subset(Peat_std_curves_long,ECOZONE_NAME_EN == "Taiga Plains"), aes(Core_C_density,MIDDEPTH, colour=CaMPNutrient_2024))+geom_smooth(size=1.5) + ylim(300,0) + xlim(0,250) + labs(x = "Core Carbon density kg m^-2", y = "Depth from surface (cm)") + labs(title="example Taiga Plains ecozone-specific density curves") #+ facet_grid(rows = vars(ECOZONE_NAME_EN))
